...
/**
 * Servlet implementation class ExtensionMatchServlet
 */
//@WebServlet("/ExtensionMatchServlet")
public class ExtensionMatchServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private String className ="ExtensionMatchServlet";

	
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ExtensionMatchServlet() {
        super();
